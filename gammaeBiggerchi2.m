...
for i = [1 2 3 5]
    ...
    % angle about the sample normal
    phi = philist(i) + phioffset;
    
    %calculate the Rotation matrix for this phi
    ...
    % We optimize t0 ourselves because we can get close enough much faster
    % than matlab using a hand-written script.
    % inside optimizet0, we re-simulate the diffraction given our new
    % strain using roisim_par_dwf. 
